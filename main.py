...
class Main_Screen(Screen):
    def __init__(self, **kwargs):
        ...
        # Получаем все методы и свойства класса в переменную attrs
        attrs = vars(self)
        # Среди всех свойств и методов берем только кнопки
        self.all_buttons = [attrs[attr] for attr in attrs if attr.startswith('btn')]
